...
- Casino index metadata in `data/lookups/casino_index.json` powers the legend modal that lists addresses (with directions links), hours, booking sites, and other per-casino details.
