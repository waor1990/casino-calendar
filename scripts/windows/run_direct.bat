...
if not exist ".venv\Scripts\python.exe" (
    ...
    echo Please run scripts\windows\setup.bat first to create the virtual environment
    pause
    exit /b 1
)
...
if !ERRORLEVEL! equ 0 (
    ...
    if !ERRORLEVEL! equ 0 (
        ...
        echo   - SCSS syntax errors in assets/styles/index.scss or imported files
...
if exist "assets\dist\style.css" (
    echo [INFO] CSS file found: assets\dist\style.css
) else (
    echo [WARN] CSS file not found: assets\dist\style.css
