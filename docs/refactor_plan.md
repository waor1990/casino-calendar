...
- [x]  Mark completed issue lines in refactor_plan.md with a ✅ or move them to a "Completed" section
- [x]  Remove or revise outdated references to legacy.py or the Plotly-based rendering logic if deprecated
- [x]  Update README.md to reflect module changes (e.g., split callback files, new utility structure)
- [x]  Trim or restructure TODO.md if items have been resolved through refactor PRs
- [x]  Review and adjust any instructions in handoff.md that refer to now-removed paths or callback flow
- [x]  Ensure any remaining changes to internal structure are reflected in AGENTS.md, especially in formatting or testing responsibilities
