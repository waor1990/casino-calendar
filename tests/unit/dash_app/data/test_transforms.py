...
from casino_calendar.dash_app.data.transforms import categorize_offer_type, categorize_offer_types
from casino_calendar.services.config_cache import clear_cache


def test_free_play_prize_phrases_classify_as_drawing() -> None:
    clear_cache()
    result = categorize_offer_type(event_name=None, offer="Win up to $500 in Free Play prizes")
